...
$$\text{Priority Score} = S_{\text{clinical}} + S_{\text{accident}} + S_{\text{ai-urgency}} + S_{\text{ai-risk}} + S_{\text{image}} + S_{\text{aging}} + S_{\text{hold-return}}$$
...
* **$S_{\text{ai-urgency}}$**: Groq AI urgency assessment (5 to 45 pts).
* **$S_{\text{ai-risk}}$**: Groq AI risk factors (5 to 40 pts).
...
* **$S_{\text{hold-return}}$**: Diagnostic hold return boost (+35 pts) for patients returning from labs/imaging.
